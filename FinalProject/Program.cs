...
do
{
    ...
    switch (cki2.Key)
    {
        case ConsoleKey.D1:
            ...
            break;
        case ConsoleKey.D2:
            string cheminFichierPlateau2 = Path.Combine("..", "..", "..", "..", "data", "Test1.csv");
            Plateau plateauRnD = new Plateau(cheminFichierPlateau2);
            plateauRnD.PersonalizeLetterPoint();
            //partie à rendre aléatoire
            
            Jeu jeuRnD = new Jeu(dico, plateauRnD, joueur1, joueur2);
